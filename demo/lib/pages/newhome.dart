...
import 'package:demo/pages/feedAuth.dart';
// import 'package:demo/pages/profile.dart';
import 'package:demo/pages/profileAuth.dart';
...
class _NewHomeState extends State<NewHome> {
  ...
  Scaffold buildAuthScreen() {
    return Scaffold(
      body: PageView(
        children: <Widget>[
          FeedAuth(currentUserId: auth.currentUser.uid),
          // ActivityFeed(),
          UploadAuth(currentUserId: currentUserId),
          Search(),
          ProfileAuth(profileId: auth.currentUser.uid),
        ],
